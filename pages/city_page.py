...
class CityPage(BasePage):
    ...
    def select_city_from_dropdown(self, city_name):
        ...
        self.click_element((By.CSS_SELECTOR, f"div.suggestion-item[data-city-name='{city_name}']"))
    ...
    def verify_city_selected(self, city_name: str):
        ...
        assert city_name in city_link.text, f"Ожидался город '{city_name}', получено: '{city_link.text}'"
