...
class AboutPage(BasePage):
    ...
    def open_about(self):
        self.click_element((By.CSS_SELECTOR, "li.menu-item[data-name='about_us'] a.menu-link"))
    ...
    def check_heading(self, expected="О НАС"):
        ...
        assert heading.text.strip() == expected, f"Заголовок: ожидалось '{expected}', получено '{heading.text}'"
