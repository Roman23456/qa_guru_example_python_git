...
class BrandsPage(BasePage):
    ...
    def open_brands(self):
        self.click_element((By.CSS_SELECTOR, "li.menu-item[data-name='brands'] a.menu-link"))
    ...
    def add_first_product_to_cart(self):
        self.click_element((By.CSS_SELECTOR, "div.add-to-cart-bar[data-opt='0'] "
    ...
    def check_product_added_notification(self):
        ...
        assert "добавлен" in notification.text.lower(), f"Неверный текст уведомления: {notification.text}"
